  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6 font-sans text-slate-800">
      <nav className="flex items-center text-sm text-slate-500 mb-8 border-b border-slate-200 pb-4">
        <button onClick={goHome} className="hover:text-[#1e3a5f] transition-colors flex items-center font-medium">
          <ChevronLeft size={16} className="mr-1" />Back to Home
        </button>
        <ChevronRight size={16} className="mx-2 text-slate-300" />
        <span className="font-bold text-[#1e3a5f]">{isPrivacy ? 'Privacy Policy' : 'Terms of Use'}</span>
      </nav>
      ...
      <div className="bg-white border border-slate-200 rounded-xl p-8 md:p-12 shadow-sm">
        <div className="mb-10 border-b border-slate-100 pb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-[#1e3a5f] font-serif mb-4">
        ...
        <div className="prose prose-slate max-w-none text-slate-600">
          {isPrivacy ? (
            <>
              ...
              <p>Visa-SIJS.com is designed as an informational resource. We do not require user registration, and we do not proactively collect personally identifiable information (PII). We use minimal analytics (Vercel Analytics) to understand general site traffic patterns.</p>
              ...
              <p>All connections to Visa-SIJS.com are encrypted via SSL/HTTPS. We do not store user-submitted information on our servers.</p>
            </>
          ) : (
            <>
              <h3>1. Informational Nature</h3>
              <p>The content on Visa-SIJS.com is exclusively for educational and informational purposes. <strong>It does not constitute legal advice</strong> and does not establish an attorney-client relationship. Immigration laws are complex and subject to change; always consult a qualified attorney for your specific case.</p>
              <h3>2. Use of Site</h3>
              ...
              <p>Visa-SIJS.com and its creators are not responsible for any actions taken based on the information contained on this site. We do not guarantee that information is error-free or completely up-to-date at the time of reading.</p>
